...
export abstract class BaseRenderer {
  ...
  protected pipelineLayout: GPUPipelineLayout | "auto" = "auto";
  ...
  protected createPipelineLayout(pipelineLayout: GPUPipelineLayoutDescriptor) {
    this.pipelineLayout = this.device.createPipelineLayout(pipelineLayout);
  }
